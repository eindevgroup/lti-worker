...
export const LTI_REGISTRATION_FINISH_PATH: string = '/lti/register_finish';

// LTI Services
export const LTI_NAMES_AND_ROLES_PATH: string = 'lti/names_and_roles';
export const LTI_SIGN_DEEP_LINK_PATH: string = 'lti/sign_deep_link';
